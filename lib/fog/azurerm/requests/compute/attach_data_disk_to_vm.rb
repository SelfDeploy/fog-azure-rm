    ...
    class AzureRM
      ...
      class Real
        def attach_data_disk_to_vm(disk_params, async)
          ...
          disk_names = disk_params[:disk_names] || [disk_params[:disk_name]]
          ...
          data_disks = get_list_data_disks(disk_names, disk_size, lun, storage_account_name, access_key, disk_resource_group, caching)
        ...
        def get_list_data_disks(disk_names, disk_size, lun, storage_account_name, access_key, disk_resource_group, caching)
