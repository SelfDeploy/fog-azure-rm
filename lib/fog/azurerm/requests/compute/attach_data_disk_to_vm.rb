    ...
    class AzureRM
      ...
      class Real
        def attach_data_disk_to_vm(disk_params, async)
          ...
          attach_data_disks(disk_names, disk_size, vm, storage_account_name, access_key, disk_resource_group, caching)
          begin
            if async
        ...
        def attach_data_disks(disk_names, disk_size, vm, storage_account_name, access_key, disk_resource_group, caching)
